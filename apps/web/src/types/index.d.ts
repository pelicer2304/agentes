export type ConversationStage = 'abertura' | 'descoberta' | 'diagnostico' | 'explicacao_solucao' | 'tratamento_objecao' | 'conversao' | 'handoff_humano';
export type DetectedIntent = 'vendas' | 'suporte' | 'agendamento' | 'duvidas' | 'orcamento' | 'integracao' | 'curiosidade' | 'outro';
...
export type LeadStatus = 'novo' | 'qualificando' | 'frio' | 'morno' | 'quente' | 'chamar_humano' | 'convertido' | 'perdido';
...
export type EvolutionConnectionState = 'open' | 'connecting' | 'close' | 'closed' | 'unknown';
